...
- [`"01-create-table.Rmd"`](https://rpubs.com/esimms/gt_01) (The *Create Table* Family of Functions)

- [`"02-create-modify-parts.Rmd"`](https://rpubs.com/esimms/gt_02) (The *Create/Modify Parts* Family of Functions)

- [`"02z-PRACTICE-01-02.Rmd"`](https://rpubs.com/esimms/gt_02z) (Practice with examples from modules `01` and `02`)

- [`"03-format-data.Rmd"`](https://rpubs.com/esimms/gt_03) (The *Format Data* Family of Functions)

- [`"04-modify-columns.Rmd"`](https://rpubs.com/esimms/gt_04) (The *Modify Columns* Family of Functions)

- [`"04z-PRACTICE-03-04.Rmd"`](https://rpubs.com/esimms/gt_04z) (Practice with examples from modules `03` and `04`)

- [`"05-summaries.Rmd"`](https://rpubs.com/esimms/gt_05) (The *Add Rows* Family of Functions)

- [`"06-table_option_functions.Rmd"`](https://rpubs.com/esimms/gt_06) (The Family of *Table Option Functions*)

- [`"06z-PRACTICE-05-06.Rmd"`](https://rpubs.com/esimms/gt_06z) (Practice with examples from modules `05` and `06`)
